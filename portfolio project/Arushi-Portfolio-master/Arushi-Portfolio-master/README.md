# Arushi Jain - Personal Portfolio Website
...
**Note**: This portfolio is based on the same template as the Ayush Rai Portfolio project, with customized content for Arushi Jain.
...
```
Arushi-Portfolio-master/
├── index.html              # Main HTML file with complete website structure
├── competitiveProgramming.html  # Programming profile page
├── webDev.html             # Web designing projects page
├── softwareDev.html        # Deep learning and ML projects page
├── androidDev.html         # Android applications page
├── Arushi_Jain(VIT).pdf    # Resume/CV
...
└── ss9.JPG                 # Additional image asset
```
...
## Template Similarity Note

**Important**: This portfolio website is based on the same template as the "Ayush Rai Portfolio" project. Both projects share:

- Identical HTML/CSS structure
- Same JavaScript functionality
- Identical technical debt and improvement opportunities
- Same underlying template framework

**Benefit**: Improvements made to one project can be easily applied to the other, as they share the same codebase structure.
...
- **Email**: [arushivds0302@gmail.com](mailto:arushivds0302@gmail.com)
- **LinkedIn**: [Arushi Jain](https://www.linkedin.com/in/arushi-jain-684543190/)
- **GitHub**: [Arushi0302](https://github.com/Arushi0302)
