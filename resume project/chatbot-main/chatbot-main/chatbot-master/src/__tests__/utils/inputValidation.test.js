...
describe('Input Validation Utilities', () => {
    describe('validateInput', () => {
        ...
        it('should reject empty input', () => {
            expect(() => validateInput('')).toThrow('Message cannot be empty');
            expect(() => validateInput('   ')).toThrow('Message cannot be empty');
            expect(() => validateInput(null)).toThrow('Message cannot be empty');
            expect(() => validateInput(undefined)).toThrow('Message cannot be empty');
            expect(() => validateInput(123)).toThrow('Message cannot be empty');
        });

        it('should reject input that is too long', () => {
            const longMessage = 'a'.repeat(1001);
            expect(() => validateInput(longMessage)).toThrow('Message too long (max 1000 characters)');
        });
    ...
    describe('sanitizeForDisplay', () => {
        it('should escape HTML characters for safe display', () => {
    ...
    describe('sanitizeForLogging', () => {
        it('should redact sensitive information', () => {
            const logInput = 'User login: password=secret123, token=abc123, ip=192.168.1.1, email=test@example.com';
            ...
            expect(sanitized).toContain('User login:');
        });
