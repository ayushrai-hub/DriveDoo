/**
 * Error Boundary component for the react-portfolio application
...
class ErrorBoundary extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        ...
        console.error('Portfolio Error Boundary caught an error:', error);
                ...
                <div className="error-boundary">
                    <div className="error-boundary__content">
                        ...
                        <p className="error-boundary__message">
                            We're sorry, but the portfolio encountered an unexpected error.
                        </p>
